...
import { APPLICATION_API_END_POINT, JOB_API_ENDPOINT } from '@/utils/constant';
...
const JobDescription = () => {
  ...
  // ✅ Derive `isApplied` directly from job data and user
  const isApplied = singleJob?.applications?.some(
    (application) =>
      application?.applicant?._id === user?._id ||
      application?.applicants === user?._id || // to support older structure
